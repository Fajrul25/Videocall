...
const remoteVideo = document.querySelector(".remote-video1 video",".remote-video1 video",".remote-video1 video");
  ...
  peer = new RTCPeerConnection({
    iceServers: [
      ...
      },
      {
        ...
        username: "d72af6c4d4c5aad2a0ca9a85",
        credential: "zJoCRcwQzb6z2Mn5"
      }
    ]
  });
